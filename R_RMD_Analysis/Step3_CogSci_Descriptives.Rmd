...
Original
<!-- Overall, teams attempted more levels as rounds progressed (R1:185, R2:213, R3:232). Participants also spent less time in each level across rounds (R1: M=465.64 seconds, R2: M=428.01, R3: M=366.15) while using a similar number of turns (R1: M=59.34, R2: M=55.44, R3: M=49.12).  -->

<!-- The proportion of gold coins was low across all rounds (R1: 14.05\%, R2: 15.49\%, R3: 20.69\%) whereas the proportion of silver coins was higher (R1: 45.41\%, R2: 34.74\%, R3: 36.21\%) and equal to the proportion of levels that went unsolved (R1: 40.54\%, R2: 49.77\%, R3: 43.10\%).  -->

<!-- Another notable pattern was that teams generally took less time and required fewer turns in levels where they earned a gold (247.92 seconds; 38.25 turns) as compared to levels where they earned a silver (387.15 seconds; 54.37 turns) and for levels that went unsolved (486.08 seconds; 60.25 turns).  -->

Current

<!-- This allowed 630 (57.54\%) of the levels to be retained for evaluation (number of turns: M=54.25, SD=34.92; words per turn: M=11.48, SD=3.03).  -->
...
<!-- Of the 630 reduced levels, 107 resulted in a gold coin, 242 in a silver coin, and 281 went unsolved. As shown in Table X, teams generally took less time and required fewer turns in levels where they earned a gold, as compared to levels where they earned a silver and for levels that went unsolved.  -->
...
## TODO: look at the statistical significance of change over time... 

```

<!-- In considering performance over rounds where participants have an opportunity to improve their game-play and become more comfortable with one another, the teams, on average, attempted more levels as rounds progressed, and spent less time in each level (see Table X). And while they used a similar number of turns for the initial two rounds, there was a statistically drop-off in number of turns by the final round. The number of gold trophies earned in each round, adjusted for the number of levels attempted for that round, was overall low and stayed consistent across rounds. The proportion of silver trophies was overall higher, but also stayed consistent across rounds.  -->

<!-- A complete breakdown of time taken per level and number of turns for outcome and round is provided in the supplementary section [need to generate].   -->
