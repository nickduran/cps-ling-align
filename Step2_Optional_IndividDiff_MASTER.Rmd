...
person = read.csv('Step2_FilesToIntegrate/person.csv', sep=",") 
...
personblock = read.csv('Step2_FilesToIntegrate/person_block.csv', sep=",")
...
compositeLing_role = read.csv("Step1_PrepareFeatures.csv", header=TRUE, sep=",")

compositeLing_role =  left_join(compositeLing_role, master3)
write.csv(compositeLing_role, "Step2_Optional_IndividDiff.csv", row.names=FALSE)
