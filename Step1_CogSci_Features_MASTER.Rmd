...
PennPOS_keep = read.csv("ALIGN_OUTPUT/PennPOS_keep_T2T.txt", sep="\t")
StanPOS_keep = read.csv("ALIGN_OUTPUT/StanPOS_keep_T2T.txt", sep="\t")
PennPOS_remove = read.csv("ALIGN_OUTPUT/PennPOS_remove_T2T.txt", sep="\t")
StanPOS_remove = read.csv("ALIGN_OUTPUT/StanPOS_remove_T2T.txt", sep="\t")
```
...
```{r}
# write.csv(df_composite, "Step1_PrepareFeatures.csv", row.names=FALSE)
```
